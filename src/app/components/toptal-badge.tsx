...
import styles from "./toptal-badge.module.css";

const TOPTAL_PROFILE_URL =
  "https://www.toptal.com/developers/resume/antonio-maina#N5GzKV";
    ...
    >
      <div className={styles.hexOuter}>
        <div className={styles.hexInner}>
          ...
          <span className={styles.vettedBy}>Vetted by</span>
          <svg
